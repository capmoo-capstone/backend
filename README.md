...
| GET    | `/unit-group/contract-summary`    | Get unit contract-phase summary          |
| GET    | `/individual-summary`             | Get a staff member's unit-phase summary  |
| GET    | `/individual-todo`                | Get a selected user's project-own queue  |
| GET    | `/individual-todo/total`          | Get a selected user's project-own totals |
...
| -------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Staff performance    | Counts each staff member's in-progress and completed phase work separately for their selected unit; `projectCount` is their total. A phase is attributed by its saved phase-owner unit, not the unit's current type. Average duration in working days uses completed phase work only.                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| Individual summary   | Compares the selected staff member's average completed phase duration with the unit average, in working days. Procurement and contract work are selected by their saved phase-owner unit, so a unit can receive credit for both phases.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| Contract summary     | Average completed contract-phase duration in working days for projects whose saved contract owner is the selected unit.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| Executive summary    | Longest procurement method, average duration, and workload-duration timeline use saved unit-owned project phases and working-day durations. A closed project's endpoint is its `STATUS_UPDATE` history record that changed status to `CLOSED`, rather than its mutable `updated_at`; legacy records without that history fall back to `updated_at`. The completion timestamp is used only while the current project status is still `CLOSED`.                                                                                                                                                                                                                                                                                                             |
| Procurement details  | Uses saved procurement-phase ownership. Average completed procurement and, when the same unit owns it, contract phase durations use working days; the delayed-rate trend compares the current range with the prior range. No completed phase returns `0`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| Top delayed projects | `totalDays` is elapsed working time for projects owned by the selected procurement unit. The non-overlapping chart stages are assignment, procurement, and approval. Procurement days exclude approval intervals, so `assignmentDays + procurementDays + approvalDays` equals `totalDays`. Approval time runs from submission to completion; rejected submissions end at the rejection decision, unresolved submissions run through today, and direct completions with no approval event contribute `0`. |
